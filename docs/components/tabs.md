...
已覆盖默认线形、卡片、边框卡片、上/右/下/左四方向、图标标签、禁用项、可关闭、可新增、editable、溢出滚动、键盘导航、标签内容区绘制、按索引/名称激活、状态读回、Python 封装、易语言命令文档和 `component_gallery.py` 桌面端完整样式演示。
...
该测试覆盖三种类型、四方向、扩展项目、按名称激活、内容读回、editable、增删回调、滚动和纵向键盘导航。
