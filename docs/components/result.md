...
| 组件分类 | 反馈/浮层 |
| Python helper | `tests/python/test_new_emoji.py` 中的 `create_result` 或同类 helper |
...
# 请根据 `tests/python/test_new_emoji.py` 中的 helper 创建 `Result`。
...
如果 `Result` 新增、删除、重命名或修改 API，必须同步更新本文件、`docs/components/README.md`、`docs/api-index.md`、`tests/python/test_new_emoji.py` 和 `DLL命令/易语言DLL命令.md`。
