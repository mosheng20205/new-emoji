...
| 组件分类 | 复杂选择 |
| Python helper | `examples/python/new_emoji_ui.py` 中的 `create_tree_select` 或同类 helper |
...
# 请根据 `examples/python/new_emoji_ui.py` 中的 helper 创建 `TreeSelect`。
...
如果 `TreeSelect` 新增、删除、重命名或修改 API，必须同步更新本文件、`docs/components/README.md`、`docs/api-index.md`、`examples/python/new_emoji_ui.py` 和 `DLL命令/易语言DLL命令.md`。
