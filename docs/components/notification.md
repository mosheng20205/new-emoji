...
# 请根据 `examples/python/new_emoji_ui.py` 中的 helper 创建 `Notification`。
...
如果 `Notification` 新增、删除、重命名或修改 API，必须同步更新本文件、`docs/components/README.md`、`docs/api-index.md`、`examples/python/new_emoji_ui.py` 和 `DLL命令/易语言DLL命令.md`。
